export default class Ibh {

    static replaceTemplateVariables = (rootElement, variables) => {
    ...
    static cloneTemplate = ({ selector = 'template', variables }) => {
        const template = document.querySelector(selector)
        let clone = template.content.cloneNode(true)
        clone = Ibh.replaceTemplateVariables(clone, variables)
        return clone
    }
